...
abstract class Kohana_Controller_Rest extends Controller
{
    ...
    /**
     * List of actions not to be authenticated.
     *
     * @var Array
     */
    protected $_exclude_auth = array();
    ...
    public function before()
    {
        ...
        if ($action_requested && 'index' !== $action_requested) {
            ...
            if (
                ...
                $this->request->param($this->resource_id)
            ) {
    ...
    {
        if (in_array($this->request->action(), $this->_exclude_auth)) {
            $this->_auth_type = RestUser::AUTH_TYPE_OFF;
        }
